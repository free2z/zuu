 ...
 * WebView and open in the OS browser; browser builds retain inline embeds.
 * That branch is unchanged by the surface split: relaxing it (and `frame-src`
 * with it) is the reviewed change this app exists to make, not a side effect
 * of moving the file (#904).
 */
  ...
  return (
    ...
    >
      <MarkdownLink
        ...
        href={href}
      >
        Open {provider} video outside free2z
      </MarkdownLink>
    </p>
  );
}
