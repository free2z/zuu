...
if [[ -n "$profile_uuid" ]] &&
  ...
  echo "Apple credential canary found the free2z provisioning profile" >&2
  exit 1
fi
...
echo "Apple credential canary: no free2z signing or store-upload authority is present."
