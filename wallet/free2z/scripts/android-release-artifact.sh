...
# ZUULI names replaced. The three apps ship on their own schedules and must be
# able to move their bundletool pin independently.
set -euo pipefail

BUNDLETOOL_JAR=bundletool-all-1.18.3.jar
BUNDLETOOL_VERSION=1.18.3
ARTIFACT_NAME=free2z-android-unsigned.aab
APPLICATION_ID=cash.free2z.free2z
...
# where a human would put it, and "free2z-android-unsigned.aab" does not. A
