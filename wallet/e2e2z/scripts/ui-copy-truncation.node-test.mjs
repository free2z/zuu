 ...
 *
 * A port of `wallet/zuuli/scripts/ui-copy-truncation.node-test.mjs` (#904
 * phase 3), carrying the two rules that are about copy and layout. ZUULI's
 * third test — the product-chrome explainer audit — is about the Search
 * surface and stays with it.
 *
 ...
 *
 * The runtime counterpart in ZUULI is `tests/viewport.pw.ts`; here the browser
 * run is `tests/messaging.pw.ts`.
 */
