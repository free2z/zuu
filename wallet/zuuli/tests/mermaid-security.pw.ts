...
test("advisory trigger is bounded and cannot block wallet navigation", async ({ page }) => {
  ...
  await expect(page.getByRole("heading", { name: /Wallet|Zcash wallet/i })).toBeVisible();
