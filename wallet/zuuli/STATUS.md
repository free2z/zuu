...
`7bf653b16dcecedb5768f616d47a703aa14bbd38` on 2026-08-30. Before a release,
update the evidence and disposition for every non-ready row; do not carry this
commit or date forward mechanically.

At that exact anchor, the required [wallet/zuuli gate](https://github.com/free2z/zuu/actions/runs/33298998404),
[rs gate](https://github.com/free2z/zuu/actions/runs/33298998323), and
[server-image policy/builds](https://github.com/free2z/zuu/actions/runs/33298998317)
all completed successfully. The latest first-parent
[four-target packaging smoke](https://github.com/free2z/zuu/actions/runs/33294584946)
also completed successfully at `4b939558a21dc38164ff2b2fb56263ebc855acf2`;
the only later first-parent change was the `rs/`-only relay-testkit shutdown fix
in [#802](https://github.com/free2z/zuu/pull/802). These are source, test, and
...
Safe unauthenticated requests on 2026-08-30 returned the following status and
top-level contracts:

```text
GET  /api/zpage/?page_size=1                 200  count,next,previous,results (count: 3899)
...
as of 2026-08-30, neither the repository nor the physical-device tracking issues
