...
for (const [label, text, expectedCount] of [
  ["protected profile associated-domain guard", releaseWorkflow, 1],
  ["embedded and signed IPA associated-domain guards", verifyIosIpa, 2],
]) {
  expect(
    label,
    occurrenceCount(
