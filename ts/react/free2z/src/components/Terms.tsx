    ...
    return (
        <div style={{
            ...
            <ul>
                ...
                <li>
                    <p>
                        <strong>Country</strong> refers to: Delaware, United
                        States
                    </p>
                </li>
                <li>
                    <p>
                        ...
                        &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot;
                        or &quot;Our&quot; in this Agreement) refers to 2z Inc.,
                ...
                <li>
                    <p>
                        <strong>Website</strong> refers to Free2z, accessible
                        from [https://free2z.com and
                        https://free2z.cash](https://free2z.com and
                        https://free2z.cash)
                    </p>
                </li>
                <li>
            ...
            <p>
                ...
                a Promotion conflict with these Terms, the Promotion rules will
                apply.
            </p>
            <h1>User Accounts</h1>
            <p>
            ...
            <p>
                ...
                objectionable. Examples of such objectionable Content include,
            ...
            <p>
                ...
                on the Service infringes a copyright or other intellectual
            ...
            <p>
                ...
                help@free2z.com and include in Your notice a detailed
            ...
            <p>
                ...
                help@free2z.com. Upon receipt of a notification, the Company
                will take whatever action, in its sole discretion, it deems
                appropriate, including removal of the challenged content from
                the Service.
            </p>
            ...
            <ul>
                <li>
                    By email:{" "}
                    <Link href="mailto: help@free2z.com">help@free2z.com</Link>
                </li>
            </ul>
        </div>
    )
