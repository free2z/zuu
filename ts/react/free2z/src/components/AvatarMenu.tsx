...
import {
    ManageAccounts, AddCircle, LiveTv, TravelExplore, Upload,
    Diversity2Outlined, Home, Search, Login, HelpOutline,
} from "@mui/icons-material";
import {
    IconButton, Avatar, Menu, Tooltip, MenuItem, Typography, Box,
    MenuItemProps,
} from "@mui/material";
...
export function MenuItemWithIcon<T extends React.ElementType = React.ElementType>(
...
export default function AvatarMenu() {
    ...
    const [isActive, setIsActive] = useState(location.pathname.startsWith("/edit/new"));
        ...
        <>
            <Tooltip title={avatarTool}>
                <IconButton onClick={handleMenuOpen}>
                    <Avatar
                        src={creator.avatar_image?.thumbnail} color="info"
                    />
                </IconButton>
            </Tooltip>
            <Menu
